...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/MC_DATA_COMP/Single_MC_DATA_COMP_NPfos_20GeV.pdf}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/MC_DATA_COMP/Single_MC_DATA_COMP_NPfos_70GeV.pdf} \\
  \end{center}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/MC_DATA_COMP/Single_MC_DATA_COMP_Efficiency.pdf}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/MC_DATA_COMP/Single_MC_DATA_COMP_NPfos.pdf} \\
  \end{center}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/DATA_ONLY/Single_DATA_ONLY_ERec.pdf}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/MC_ONLY/Single_MC_ONLY_ERec.pdf} \\
  \end{center}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/DATA_ONLY/Single_DATA_ONLY_EResol.pdf}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/MC_ONLY/Single_MC_ONLY_EResol.pdf} \\
  \end{center}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/MC_DATA_COMP/Single_MC_DATA_COMP_ERec.pdf}
    \includegraphics[width=0.48\textwidth]{plots/SingleParticle/MC_DATA_COMP/Single_MC_DATA_COMP_EResol.pdf} \\
  \end{center}
